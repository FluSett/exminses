...
import '../stream_password_form.dart';
import 'send_password_reset_button.dart';
import 'stream_email_form.dart';
import 'stream_main_button.dart';
          ...
          return Column(
            children: [
              ...
              StreamPasswordForm(
                appColors: appColors,
                validationCubit: validationCubit,
                labelText: signInPasswordFormLabel.i18n,
              ),
              ...
              StreamMainButton(
                ...
                callback: () => context
                    ...
                    .add(AuthenticationEvent.signInWithEmailAndPassword(
